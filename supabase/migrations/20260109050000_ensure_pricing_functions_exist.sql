-- Migration: Ensure Pricing Functions Exist
-- Purpose: Ensure all pricing functions exist in public schema with proper qualification
-- Date: 2026-01-09
-- 
-- This migration ensures that find_applicable_discounts, apply_discount_stacking,
-- and compute_product_price functions exist and are properly qualified.
-- If they already exist, this will update them with proper schema qualification.
